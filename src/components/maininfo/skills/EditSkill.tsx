...
const EditSkill = ({skill, handleStatus, mutate}: {skill?: skill, handleStatus: Function, mutate: Function}) => {
    ...
    const {icon} = formData;
    return(<div>
        <form className="border-2 p-2  rounded mx-auto" onSubmit={(e) => e.preventDefault()}>
